...
export class PrivacyRuleComponent {
    //#region Resource
    ...
    ngOnInit() {
        ...
        this.effects.push({ label: 'Permit', value: 'Permit' });
        this.effects.push({ label: 'Deny', value: 'Deny' });
        this.selected_policy_effect = this.effects[0].value;
